...
function updateMapForDimension(dimension) {
  ...
  // Get the appropriate scores based on dimension
  if (dimension === "Composite Index") {
    averageScores = computeCompositeScores(parsedData);
  } else {
    averageScores = computeAverageScores(parsedData, dimension);
  }
